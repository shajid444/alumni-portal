...
import { FaArrowRight, FaHome, FaInbox } from "react-icons/fa";
...
const Navbar = () => {
    ...
    const navOptions = <>
        <li className='text-black rounded-lg'> <Link to='/'><a><FaHome></FaHome></a> </Link> </li>

        <li className='text-black'> <Link to='/allAlumni'><a>All Alumni</a> </Link> </li>
        <li className='text-black'> <Link to='/allAlumni'><a>Events</a> </Link> </li>
        <li className='text-black'> <Link to='/newsBlogs'><a>Blogs</a> </Link> </li>
        <li className='text-black'> <Link to='/notice'><a>Notice</a> </Link> </li>


        <li className='text-black'> <Link to='/addAlumni'><a>Add+</a> </Link> </li>


        <li className=''>
            <details className="dropdown">
                <summary className="btn m-1 bg-[#fcdc5d] border-0">Community</summary>
                <ul className="menu dropdown-content  rounded-box z-[1] w-40 p-2 ">
                    <li><Link to='/job'>Find Job <FaArrowRight></FaArrowRight> </Link></li>
                    <li><Link to='/stories'>Stories <FaArrowRight></FaArrowRight></Link></li>
                </ul>
            </details>
    ...
    return (
        ...
        <div className="shadow-lg rounded-lg navbar  max-w-screen-xl bg-[#fcdc5d]">
