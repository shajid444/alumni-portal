...
const Stories = () => {
    return (
        <section className=' story h-auto border bg-slate-100 p-8 flex justify-between'
            style={{
            ...
            <div className=''>
                ...
                <div className="max-w-md p-8 sm:flex sm:space-x-6 dark:bg-gray-50 dark:text-gray-800 group">
                    <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0 overflow-hidden">
                        <img src="https://i.ibb.co.com/fn4WSqV/jeshoots-com-2v-D8l-Ihdnw-unsplash-1.jpg" alt="" className="object-cover object-center w-full h-full rounded-3xl shadow-2xl dark:bg-gray-500 transform transition-transform duration-300 group-hover:scale-110" />
                    </div>
                    <div className="flex flex-col space-y-4">
                        <div>
                            <span className="text-sm dark:text-gray-600 flex items-center gap-2"> <MdDateRange />June 07, 2024</span>
