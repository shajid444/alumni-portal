        ...
        <div className="w-full pt-24 mx-auto mt-10 mb-10 max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
            ...
            <form onSubmit={handleSubmit(onSubmit)} noValidate="" action="" className="space-y-6">
                ...
                <div className="space-y-1 text-sm">
                    ...
                    <input type="name"   {...register("name")} name="name" id="name" placeholder="user-name" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-teal-600" />
