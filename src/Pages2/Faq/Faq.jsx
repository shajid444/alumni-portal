...
const Faq = () => {
    return (
        <section className="dark:bg-gray-100 dark:text-gray-800">
            <div className="container flex  justify-between px-4 py-8 mx-auto md:p-8">
                <div>
                ...
                <div className="space-y-4">
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:dark:ring-teal-600">Ex orci laoreet egestas sapien magna egestas scelerisque?</summary>
                    ...
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:dark:ring-teal-600">Lorem at arcu rutrum viverra metus sapien venenatis lobortis odio?</summary>
                    ...
                    <details className="w-full border rounded-lg">
                        <summary className="px-4 py-6 focus:outline-none focus-visible:dark:ring-teal-600">Eleifend feugiat sollicitudin laoreet adipiscing bibendum suscipit erat?</summary>
